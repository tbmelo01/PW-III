        ...
        <!-- <div class="container"> -->
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" style="height:30em">
                    <div class="carousel-item active" style="background-image: url('./img/img1.png');"></div>
                    ...
                    <!-- <div class="carousel-item active">
                        <img class="d-flex w-100" src="./img/img1.png" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-flex w-100" src="../img/img2.png" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-flex w-100" src="../img/img3.png" alt="Third slide">
                    </div> -->
                </div>
                <a
